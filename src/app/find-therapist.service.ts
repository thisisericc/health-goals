...
export class FindTherapistService {
  ...
  getonlyTherapists(){
    const my_url='https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=occupational-therapist%2Coccupational-therapist-environmental-modification%2Crecreation-therapist&location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&skip=0&limit=100&user_key=09fd788402c043185e2d8aa505cb01ff';
    console.log(my_url);
    debugger;
  ...
  getonlyPsychologists(){
    const my_url="https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=adult-psychologist%2Cclinical-child-psychologist%2Cmental-retardation-psychologists%2Cmedical-psychologist%2Cgroup-psychotherapy-psychologist%2Chealth-service-psychologist%2Ccognitive-behavioral-psychologist%2Cpsychologist%2Caddiction-psychologist%2Chealth-psychologist%2Cfamily-psychologist&location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&skip=0&limit=100&user_key=1acf4fc370a08033a801b6bad1cd40d2";
    console.log(my_url);
    return this.http.get(my_url)
    .pipe(
      catchError(this.errorHandler)
  ...
  getonlyPsychiatrist(){
    const my_url="https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=psychiatrist&location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&skip=0&limit=10&user_key=4148c5f0b800ddd4a9cafd0822547a88";
    return this.http.get(my_url)
    .pipe(
      catchError(this.errorHandler)
    );
  ...
  getonlyCounselors(){
    const my_url="https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=professional-counselor%2Cmental-health-counselor%2Caddiction-counselor&location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&skip=0&limit=10&user_key=3d2523a7d9df82fbaa616ddc952ccc34";
    return this.http.get(my_url)
    .pipe(
      catchError(this.errorHandler)
    );
