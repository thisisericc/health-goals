...
export class FindTherapistService {
  ...
  getTherapist(){
    ...
    return this.http.get(encodeURI('https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=professional-counselor,psychiatrist,mental-health-counselor&location=34.052235,-118.243683,100&skip=2&limit=100&user_key=2bd6df991f4d47275948ff4ece06e299'))
    .pipe(
